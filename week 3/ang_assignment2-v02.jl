...
# To do: θ_zero should not be penalized
function cost(θ, X, y)
...
# cost will not decrease on every iteration because gd() is not yet optimized
# To do: gd() should also be monitored for convergence
